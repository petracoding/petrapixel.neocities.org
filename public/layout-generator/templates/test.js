...
// Insert your header HTML inside these ``. You can use HTML as usual. You don't need to use the <header> element, but I recommend it.
const headerEl = `
  	<header>Header...</header>
  	  `;

// Insert your footer HTML inside these ``. You can use HTML as usual. You don't need to use the <footer> element, but I recommend it.
const footerEl = `
